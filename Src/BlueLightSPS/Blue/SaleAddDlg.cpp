...
//		{ 100 * 1 + 100 * 0, 40 * 4, 100, 20 }, //Edit_ZXCD,		//删除优先级轴承前的位置
		{ 100 * 1 + 100 * 0, 40 * 3, 100, 20 }, //Edit_ZXCD,

		{ 100 * 4 + 100 * 3, 40 * 4, 100, 20 }, //Edit_GH,

//		{ 100 * 1 + 100 * 0, 40 * 8, 500, 60 } //Edit_BZ,		//删除优先级轴承前的位置
...
// 		{ 100 * 0 + 100 * 0, 40 * 2, 100, 20 }, //Static_ZC,	//删除优先级轴承前的位置
// 		{ 100 * 1 + 100 * 1, 40 * 2, 100, 20 }, //Static_DFR,	//删除优先级轴承前的位置
		{ 0, 0, 0, 0 }, //Static_ZC,
		{ 0, 0, 0, 0 }, //Static_DFR,
...
// 		{ 100 * 0 + 100 * 0, 40 * 3, 100, 20 }, //Static_JF,		//删除优先级轴承前的位置
// 		{ 100 * 1 + 100 * 1, 40 * 3, 100, 20 }, //Static_BPQXH,		//删除优先级轴承前的位置
...
//		{ 100 * 0 + 100 * 0, 40 * 4, 100, 20 }, //Static_ZXCD,		//删除优先级轴承前的位置
		{ 100 * 0 + 100 * 0, 40 * 3, 100, 20 }, //Static_ZXCD,

// 		{ 100 * 1 + 100 * 1, 40 * 4, 100, 20 }, //Static_YXJ		//删除优先级轴承前的位置
 		{ 0, 0, 0, 0 }, //Static_YXJ			

		{ 100 * 2 + 100 * 2, 40 * 4, 100, 20 }, //Static_DDRQ,
		{ 100 * 3 + 100 * 3, 40 * 4, 100, 20 }, //gh

//		{ 100 * 0 + 100 * 0, 40 * 5, 100, 20 },	//zjdy		//删除优先级轴承前的位置
//		{ 100 * 1 + 100 * 1, 40 * 5, 100, 20 }, //zjys		//删除优先级轴承前的位置
...
//		{ 100 * 0 + 100 * 0, 40 * 6, 100, 20 }, //bzgg
//		{ 100 * 1 + 100 * 1, 40 * 6, 100, 20 }, //zzs
		{ 100 * 0 + 100 * 0, 40 * 5, 100, 20 }, //bzgg
		{ 100 * 1 + 100 * 1, 40 * 4, 100, 20 }, //zzs

		
//		{ 100 * 2 + 100 * 2, 40 * 6, 100, 20 }, //khqy		//删除优先级轴承前的位置
		{ 100 * 1 + 100 * 1, 40 * 5, 100, 20 }, //khqy

//		{ 100 * 0 + 100 * 0, 40 * 7, 100, 20 }, //Static_MPZL,		//删除优先级轴承前的位置
//		{ 100 * 0 + 100 * 0, 40 * 8, 100, 20 }  //Static_BZ,		//删除优先级轴承前的位置
...
//		{ 100 * 1 + 100 * 0, 40 * 3, 100, 20 }, //Comb_JF,		//删除优先级轴承前的位置
		{ 100 * 1 + 100 * 0, 40 * 2, 100, 20 }, //Comb_JF,

//		{ 100 * 2 + 100 * 1, 40 * 3, 100, 20 }, //Comb_BPQXH,	//删除优先级轴承前的位置
		{ 100 * 2 + 100 * 1, 40 * 2, 100, 20 }, //Comb_BPQXH,

		{ 100 * 3 + 100 * 2, 40 * 3, 100, 20 }, //Comb_BMQXH,
//		{ 100 * 2 + 100 * 1, 40 * 4, 100, 20 },	//Comb_YXJ
		{ 0, 0, 0, 0 },	//Comb_YXJ
		
//		{ 100 * 1 + 100 * 0, 40 * 5, 100, 20 }, //zjdy		//删除优先级轴承前的位置
		{ 100 * 1 + 100 * 0, 40 * 4, 100, 20 }, //zjdy

//		{ 100 * 2 + 100 * 1, 40 * 5, 100, 20 }, //zjys		//删除优先级轴承前的位置
		{ 100 * 2 + 100 * 1, 40 * 3, 100, 20 }, //zjys

		{ 100 * 3 + 100 * 2, 40 * 5, 100, 20 }, //zdqxh
		{ 100 * 4 + 100 * 3, 40 * 5, 100, 20 }, //zyz

//		{ 100 * 1 + 100 * 0, 40 * 6, 100, 20 }, //bzxgg		//删除优先级轴承前的位置
		{ 100 * 1 + 100 * 0, 40 * 5, 100, 20 }, //bzxgg

//		{ 100 * 2 + 100 * 1, 40 * 6, 100, 20 }, //zzs		//删除优先级轴承前的位置
		{ 100 * 2 + 100 * 1, 40 * 4, 100, 20 }, //zzs

//		{ 100 * 3 + 100 * 2, 40 * 6, 100, 20 }, //khqy		//删除优先级轴承前的位置
		{ 100 * 2 + 100 * 1, 40 * 5, 100, 20 }, //khqy

//		{ 100 * 1 + 100 * 0, 40 * 7, 500, 20 } //Comb_MPZL,		//删除优先级轴承前的位置
