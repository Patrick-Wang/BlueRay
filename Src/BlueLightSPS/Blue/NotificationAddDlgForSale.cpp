...
static int g_StaticPos[][4] = {
		...
		{ 100 * 1 + 100 * 1, 40 * 2 - 15, 100, 20 }, //Static_ZDQDY,
		{ 100 * 2 + 100 * 2, 40 * 2 - 15, 100, 20 }, //Static_YYLGG,
		{ 100 * 3 + 100 * 3, 40 * 2 - 15, 100, 20 }, //Static_JF,
		{ 100 * 0 + 100 * 0, 40 * 3 - 15, 100, 20 }, //Static_BPQXH,
		{ 100 * 1 + 100 * 1, 40 * 3 - 15, 100, 20 }, //Static_BMQXH,
		{ 100 * 2 + 100 * 2, 40 * 3 - 15, 100, 20 }, //Static_DLCD,
		{ 100 * 3 + 100 * 3, 40 * 3 - 15, 100, 20 }, //Static_ZXCD,
		{ 100 * 0 + 100 * 0, 40 * 4 - 15, 100, 20 }, //Static_MPZL,
		{ 100 * 1 + 100 * 1, 40 * 4 - 15, 100, 20 }, //Static_DDRQ,
		{ 100 * 2 + 100 * 2, 40 * 4 - 15, 100, 20 }, 	//zjdy
		{ 100 * 3 + 100 * 3, 40 * 4 - 15, 100, 20 }, 	//zjys
		{ 100 * 0 + 100 * 0, 40 * 5 - 15, 100, 20 }, 	//zdqxh
		{ 100 * 1 + 100 * 1, 40 * 5 - 15, 100, 20 }, 	//zyz
		{ 100 * 2 + 100 * 2, 40 * 5 - 15, 100, 20 }, 	//bzxgg
		{ 100 * 3 + 100 * 3, 40 * 5 - 15, 100, 20 }, 	//zzs
		{ 100 * 0 + 100 * 0, 40 * 6 - 15, 100, 20 }, 	//khqy
		{ 100 * 1 + 100 * 1, 40 * 6 - 15, 100, 20 }, 	//gh
		{ 100 * 2 + 100 * 2, 40 * 6 - 15, 100, 20 }, 	//ywsh
		{ 100 * 3 + 100 * 3, 40 * 6 - 15, 100, 20 }, 	//jhsh
...
static int g_StaticToShowPos[][4] = {
		...
		{ 100 * 1 + 100 * 0 + 8, 40 * 2 - 15, 100, 20 }, //Static_ZC,
		{ 100 * 2 + 100 * 1 + 8, 40 * 2 - 15, 100, 20 }, //Static_ZDQDY,
		{ 100 * 3 + 100 * 2 + 8, 40 * 2 - 15, 100, 20 }, //Static_YYLGG,
		{ 100 * 4 + 100 * 3 + 8, 40 * 2 - 15, 100, 20 }, //Static_JF,
		{ 100 * 1 + 100 * 0 + 8, 40 * 3 - 15, 100, 20 }, //Static_BPQXH,
		{ 100 * 2 + 100 * 1 + 8, 40 * 3 - 15, 100, 20 }, //Static_BMQXH,
		{ 100 * 3 + 100 * 2 + 8, 40 * 3 - 15, 100, 20 }, //Static_DLCD,
		{ 100 * 4 + 100 * 3 + 8, 40 * 3 - 15, 100, 20 }, //Static_ZXCD,
		{ 100 * 1 + 100 * 0 + 8, 40 * 4 - 15, 100, 20 }, //Static_MPZL,
		{ 100 * 2 + 100 * 1 + 8, 40 * 4 - 15, 100, 20 }, //Static_DDRQ,
		{ 100 * 3 + 100 * 2 + 8, 40 * 4 - 15, 100, 20 }, 	//zjdy
		{ 100 * 4 + 100 * 3 + 8, 40 * 4 - 15, 100, 20 }, 	//zjys
		{ 100 * 1 + 100 * 0 + 8, 40 * 5 - 15, 100, 20 }, 	//zdqxh
		{ 100 * 2 + 100 * 1 + 8, 40 * 5 - 15, 100, 20 }, 	//zyz
		{ 100 * 3 + 100 * 2 + 8, 40 * 5 - 15, 100, 20 }, 	//bzxgg
		{ 100 * 4 + 100 * 3 + 8, 40 * 5 - 15, 100, 20 }, 	//zzs
		{ 100 * 1 + 100 * 0 + 8, 40 * 6 - 15, 100, 20 }, 	//khqy
		{ 100 * 2 + 100 * 1 + 8, 40 * 6 - 15, 100, 20 }, 	//gh
		{ 100 * 3 + 100 * 2 + 8, 40 * 6 - 15, 100, 20 }, 	//ywsh
		{ 100 * 4 + 100 * 3 + 8, 40 * 6 - 15, 100, 20 }, 	//jhsh
