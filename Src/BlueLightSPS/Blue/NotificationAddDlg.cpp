...
BEGIN_MESSAGE_MAP(CNotificationAddDlg, CPopupDlg)
// 	ON_BN_CLICKED(IDC_PLAN_ADD_BTN_NEWIDFORSCRQ, &CNotificationAddDlg::OnBnClickedNewIDForSCRQ)
// 	ON_BN_CLICKED(IDC_PLAN_ADD_BTN_NEWIDFORBZRQ, &CNotificationAddDlg::OnBnClickedNewIDForBZRQ)
END_MESSAGE_MAP()
...
CNotificationAddDlg::~CNotificationAddDlg()
{

}
// 
// void CNotificationAddDlg::OnBnClickedNewIDForSCRQ()
// {
...
// }
// 
// void CNotificationAddDlg::OnBnClickedNewIDForBZRQ()
// {
...
void CNotificationAddDlg::InitHttpInstance()
{
// 	if (m_DropList.empty())
// 	{
...
void CNotificationAddDlg::OnHttpFailed(int id)
{
// 	switch (id)
// 	{
...
void CNotificationAddDlg::OnHttpSuccess(int id, LPCTSTR resp)
{
// 	switch (id)
// 	{
// 	case QUERY_COMBO_VALUE_ZC_URL_ID:
...
void CNotificationAddDlg::OnLoadComboDataSuccess(int id, CString strValList)
{
// 	--m_iRef;
...
const std::vector<std::vector<CString>>& CNotificationAddDlg::GetDropList()
{
	return m_DropList;
}

void CNotificationAddDlg::InitCtrlData()
{
	if (NULL == m_lpOption)
	{
		d_GetOption(*this);
...
// void CNotificationAddDlg::ConfigPlanBtns(bool scrq, bool bzrq)
// {
// 	m_bEnablePlanBtnForSCRQ = scrq;
// 	m_bEnablePlanBtnForBZRQ = bzrq;
// }
// 
// void CNotificationAddDlg::DisableBHEdits(BOOL tcbh, BOOL ccbh)
// {
...
BOOL CNotificationAddDlg::OnInitDialog()
{
...
// 	m_btnNewIDForBZRQ->MoveWindow(100 * 2 + 100 * 1 + 8 + 85, 40 * 9, 35, 20);
	...
	if (NULL != m_lpOption)
	{
		...
		init(m_aStaticsToShow[StaticId2::Static2_SCRQ], m_lpOption->scrq);
		init(m_aStaticsToShow[StaticId2::Static2_BZRQ], m_lpOption->bzrq);
		init(m_aStaticsToShow[StaticId2::Static2_FHRQ], m_lpOption->fhrq);
		init(m_aStaticsToShow[StaticId2::Static2_TCBH], m_lpOption->tcbh);
		init(m_aStaticsToShow[StaticId2::Static2_CCBH], m_lpOption->ccbh);

		init(m_aStaticsToShow[StaticId2::Static2_ZC], m_lpOption->zc);
		init(m_aStaticsToShow[StaticId2::Static2_BZ], m_lpOption->bz);
		init(m_aStaticsToShow[StaticId2::Static2_CG], m_lpOption->cg);
	...
	else
	{
		...
		init(m_aStaticsToShow[StaticId2::Static2_SCRQ], val);
		init(m_aStaticsToShow[StaticId2::Static2_BZRQ], val);
		init(m_aStaticsToShow[StaticId2::Static2_FHRQ], val);
		init(m_aStaticsToShow[StaticId2::Static2_TCBH], val);
		init(m_aStaticsToShow[StaticId2::Static2_CCBH], val);


		init(m_aStaticsToShow[StaticId2::Static2_ZC], val);
		init(m_aStaticsToShow[StaticId2::Static2_BZ], val);
		init(m_aStaticsToShow[StaticId2::Static2_CG], val);
	}
...
void CNotificationAddDlg::PostNcDestroy()
{
...
// void CNotificationAddDlg::GetText(CComboBox* pComboBox, CombId comId, CString& text)
// {
...
// }
// 
// void CNotificationAddDlg::SetText(CComboBox* pComboBox, CombId comId, CString& text)
// {
// 	CString strTmp;
// 	int i = m_DropList[comId].size() - 1;
// 	for (; i >= 0; --i)
...
void CNotificationAddDlg::SetOption(Option_t* lpOpt)
{
	m_lpOption = lpOpt;
}

int CNotificationAddDlg::m_iRef = 0;

std::vector<std::vector<CString>> CNotificationAddDlg::m_DropList;

BOOL CNotificationAddDlg::OnCmdMsg(UINT nID, int nCode, void* pExtra, AFX_CMDHANDLERINFO* pHandlerInfo)
{
