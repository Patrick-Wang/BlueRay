...
static int g_CheckBoxPos[][4] = {
		...
		{ 80 * 4 + 80 * 3, 40 * 1, 100, 20 }, // 		{ _T("磁钢") },
		{ 80 * 1 + 80 * 0, 40 * 2, 100, 20 }, // 		{ _T("数量") },
		{ 80 * 2 + 80 * 1, 40 * 2, 100, 20 }, // 		{ _T("轴承") },
		{ 0, 0, 0, 0 },							// 		{ _T("单复绕") },
		{ 80 * 3 + 80 * 2, 40 * 2, 100, 20 }, // 		{ _T("制动器电压") },
		{ 80 * 4 + 80 * 3, 40 * 2, 100, 20 }, // 		{ _T("曳引轮规格") },
		{ 80 * 1 + 80 * 0, 40 * 3, 100, 20 }, // 		{ _T("机房") },
		{ 80 * 2 + 80 * 1, 40 * 3, 100, 20 }, // 		{ _T("变频器型号") },
		{ 80 * 3 + 80 * 2, 40 * 3, 100, 20 }, // 		{ _T("编码器型号") },
		{ 80 * 4 + 80 * 3, 40 * 3, 100, 20 }, // 		{ _T("电缆长度") },
		{ 80 * 1 + 80 * 0, 40 * 4, 100, 20 }, // 		{ _T("闸线长度") },
		{ 80 * 2 + 80 * 1, 40 * 4, 100, 20 }, // 		{ _T("铭牌等资料") },
		{ 80 * 3 + 80 * 2, 40 * 4, 100, 20 }, // 		{ _T("备注") },
		{ 80 * 4 + 80 * 3, 40 * 4, 100, 20 }, // 		{ _T("订单日期") },
		{ 80 * 1 + 80 * 0, 40 * 5, 100, 20 }, // 		{ _T("主机电压") },
		{ 80 * 2 + 80 * 1, 40 * 5, 100, 20 }, // 		{ _T("主机颜色") },
		{ 80 * 3 + 80 * 2, 40 * 5, 100, 20 }, // 		{ _T("制动器型号") },
		{ 80 * 4 + 80 * 3, 40 * 5, 100, 20 }, // 		{ _T("左/右置") },
		{ 80 * 1 + 80 * 0, 40 * 6, 100, 20 }, // 		{ _T("包装箱/底托规格") 
		{ 80 * 2 + 80 * 1, 40 * 6, 100, 20 }, // 		{ _T("工号") },
		{ 80 * 3 + 80 * 2, 40 * 6, 100, 20 }, // 		{ _T("制造商") },
		{ 80 * 4 + 80 * 3, 40 * 6, 100, 20 }, // 		{ _T("客户区域") },
		{ 0, 0, 0, 0 },							// 		{ _T("优先级") },
		{ 0, 0, 0, 0 },							// 		{ _T("业务审核") },
		{ 0, 0, 0, 0 },							// 		{ _T("计划审核") },
		{ 80 * 1 + 80 * 0, 40 * 7, 100, 20 }, // 		{ _T("生产日期") },
		{ 80 * 2 + 80 * 1, 40 * 7, 100, 20 }, // 		{ _T("计划审核-业务") },
		{ 80 * 3 + 80 * 2, 40 * 7, 100, 20 }, // 		{ _T("计划审核-计划") },
		{ 80 * 4 + 80 * 3, 40 * 7, 100, 20 }, // 		{ _T("包装日期") },
		{ 80 * 1 + 80 * 0, 40 * 8, 100, 20 }, // 		{ _T("包装审核-业务") },
		{ 80 * 2 + 80 * 1, 40 * 8, 100, 20 }, // 		{ _T("包装审核-计划") },
		{ 80 * 3 + 80 * 2, 40 * 8, 100, 20 }, // 		{ _T("发货日期") },
		{ 80 * 4 + 80 * 3, 40 * 8, 100, 20 }, // 		{ _T("投产编号") },
		{ 80 * 1 + 80 * 0, 40 * 9, 100, 20 }, // 		{ _T("出厂编号") }
};
