...
static int g_StaticToShowPos[][4] = {
		{ 100 * 1 + 100 * 0 + 8, 40 * 1 - 15, 100, 20 }, //Edit_HTH,                    Static2_HTH,
		{ 100 * 2 + 100 * 1 + 8, 40 * 1 - 15, 100, 20 }, //Comb_KHMC,					Static2_KHMC,
		{ 100 * 3 + 100 * 2 + 8, 40 * 1 - 15, 100, 20 }, //Comb_GGBH,					Static2_GGBH,
		{ 100 * 4 + 100 * 3 + 8, 40 * 1 - 15, 100, 20 }, //Edit_SL,						Static2_SL,
		{ 0, 0, 0, 0 }, //Comb_ZC,														Static2_ZC,
		{ 0, 0, 0, 0 }, //Comb_DFR,														Static2_DFR,
		{ 100 * 3 + 100 * 2 + 8, 40 * 2 - 15, 100, 20 }, //Comb_ZDQDY,					Static2_ZDQDY,
		{ 100 * 4 + 100 * 3 + 8, 40 * 2 - 15, 100, 20 }, //Comb_YYLGG,					Static2_YYLGG,
		{ 100 * 1 + 100 * 0 + 8, 40 * 2 - 15, 100, 20 }, //Comb_JF,						Static2_JF,
		{ 100 * 2 + 100 * 1 + 8, 40 * 2 - 15, 100, 20 }, //Comb_BPQXH,					Static2_BPQXH,
		{ 100 * 3 + 100 * 2 + 8, 40 * 3 - 15, 100, 20 }, //Comb_BMQXH,					Static2_BMQXH,
		{ 100 * 4 + 100 * 3 + 8, 40 * 3 - 15, 100, 20 }, //Edit_DLCD,					Static2_DLCD,
		{ 100 * 1 + 100 * 0 + 8, 40 * 3 - 15, 100, 20 }, //Edit_ZXCD,					Static2_ZXCD,
		{ 100 * 2 + 100 * 1 + 8, 40 * 3 - 15, 100, 20 },	//Comb_MPZL,				Static2_MPZL,
		{ 100 * 3 + 100 * 2 + 8, 40 * 4 - 15, 100, 20 }, //Edit_DDRQ,					Static2_DDRQ,
		{ 100 * 4 + 100 * 3 + 8, 40 * 4 - 15, 100, 20 },  //Edit_BZ,					Static2_BZ,
		{ 100 * 1 + 100 * 0 + 8, 40 * 4 - 15, 100, 20 },//zjdy							Static2_ZJDY,
		{ 100 * 2 + 100 * 1 + 8, 40 * 4 - 15, 100, 20 },//zjys							Static2_ZJYS,
		{ 100 * 3 + 100 * 2 + 8, 40 * 5 - 15, 100, 20 },//zdqxh							Static2_ZDQXH,
		{ 100 * 4 + 100 * 3 + 8, 40 * 5 - 15, 100, 20 },//zyz							Static2_ZYZ,
		{ 100 * 1 + 100 * 0 + 8, 40 * 5 - 15, 100, 20 },//bzxgg							Static2_BZXDTGG
		{ 100 * 1 + 100 * 0 + 8, 40 * 6 - 15, 100, 20 },//gh							Static2_GH,
		{ 100 * 2 + 100 * 1 + 8, 40 * 5 - 15, 100, 20 },//zzs							Static2_ZZS,
		{ 100 * 2 + 100 * 1 + 8, 40 * 6 - 15, 100, 20 },//khqy							Static2_KHQY,
		{ 0, 0, 0, 0 }	//yxj															Static2_YXJ,
};
