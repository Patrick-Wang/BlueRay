package com.BlueRay.mutton.controller.sale;
...
import com.BlueRay.mutton.service.plan.Secrets;
import com.BlueRay.mutton.service.sale.SaleService;
...
//        
	...
	public @ResponseBody String delSaleData(HttpServletRequest request,
		...
		JSONObject jo = JSONObject.fromObject(sb.toString());
		JSONArray psw = JSONArray.fromObject(jo.get("psw"));
		if (Secrets.getSecret().equals(psw.getString(0))){
